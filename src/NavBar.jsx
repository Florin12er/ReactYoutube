  ...
  return (
    <div className="flex m-auto">
      <Input
        type="text"
        name="full_name"
        className="bg-zinc-900 rounded-s-xl"
      />
      ...
      <Button className="rounded-3xl w-10 h-10 bg-neutral-600 flex justify-center items-center">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="2em"
          height="2em"
  ...
  return (
    <>
      {categories.map((category, index) => (
        <Button className="bg-neutral-600 text-white p-2 rounded ml-5" key={index}>{category}</Button>
      ))}
    </>
  );
};
